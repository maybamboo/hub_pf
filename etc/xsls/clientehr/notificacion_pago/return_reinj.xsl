	...
	<xsl:template match="/">	
	   <message>
			<header>
				...
				<!--Debido a que la notificación se hace mediante el reinyector, no contamos con el id_trx_eps-->
			...
			<body>
				...
				<!--De momento esto no cambia independiente de como se haga la notificacion-->
