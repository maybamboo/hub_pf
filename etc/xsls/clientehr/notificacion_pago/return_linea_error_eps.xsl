	...
	<xsl:template match="/">	
	   <message>
			...
			<body>
				...
				<status_code><xsl:value-of select="/request-context/services-responses/notificacion_pago/transformarResp/response/data/message/body/status/status_code" /></status_code>
				<status_desc><xsl:value-of select="/request-context/services-responses/notificacion_pago/transformarResp/response/data/message/body/status/status_desc" /></status_desc>
