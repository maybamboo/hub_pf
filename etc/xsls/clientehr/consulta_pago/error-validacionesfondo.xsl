...
<xsl:stylesheet version="1.0"
	...
	<xsl:choose>
		...
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '01'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEF101'" />
					<xsl:with-param name="statusDesc" select="'Error, Problemas al consultar el convenio informado'" />
			</xsl:call-template>	
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '02'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEF102'" />
					<xsl:with-param name="statusDesc" select="'Error, Recaudador informado no existe o no habilitado en convenio'" />
			</xsl:call-template>	
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '03'">
			<xsl:call-template name="error_msg">
		...
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '04'">
			<xsl:call-template name="error_msg">
		...
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '324'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH324'" />
					<xsl:with-param name="statusDesc" select="'Fecha de pago se encuentra vacia'" />
			</xsl:call-template>	
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '325'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH325'" />
					<xsl:with-param name="statusDesc" select="'Fecha de pago es invalida'" />
			</xsl:call-template>	
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '326'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH326'" />
					<xsl:with-param name="statusDesc" select="'Fecha contable vacia'" />
			</xsl:call-template>	
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '327'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH327'" />
					<xsl:with-param name="statusDesc" select="'Fecha contable es invalida'" />
			</xsl:call-template>	
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '328'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH328'" />
					<xsl:with-param name="statusDesc" select="'Fecha de emisor vacia'" />
			</xsl:call-template>	
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '329'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH329'" />
					<xsl:with-param name="statusDesc" select="'Fecha de emisor es invalida'" />
			</xsl:call-template>	
		</xsl:when>
	<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '330'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH330'" />
					<xsl:with-param name="statusDesc" select="'campo tipo de pago esta vacia'" />
			</xsl:call-template>	
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '331'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH331'" />
					<xsl:with-param name="statusDesc" select="'Campo tipo de pago es invalida'" />
			</xsl:call-template>	
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '332'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH332'" />
					<xsl:with-param name="statusDesc" select="'Campo metodo de pago esta vacia'" />
			</xsl:call-template>	
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '333'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH333'" />
					<xsl:with-param name="statusDesc" select="'Metodo de pago es invalida'" />
			</xsl:call-template>	
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '339'">
			<xsl:call-template name="error_msg">
		...
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '336'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH336'" />
					<xsl:with-param name="statusDesc" select="'Monto total esta vacia'" />
			</xsl:call-template>	
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '337'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH337'" />
					<xsl:with-param name="statusDesc" select="'Monto total es invalida'" />
			</xsl:call-template>	
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '338'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH338'" />
					<xsl:with-param name="statusDesc" select="'El campo Monto es vacio'" />
			</xsl:call-template>	
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '340'">
			<xsl:call-template name="error_msg">
		...
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '301'">
			<xsl:call-template name="error_msg">
		...
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '302'">
			<xsl:call-template name="error_msg">
		...
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '303'">
			<xsl:call-template name="error_msg">
		...
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '304'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH304'" />
					<xsl:with-param name="statusDesc" select="'identificador de compañia es invalido'" />
			</xsl:call-template>
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '305'">
			<xsl:call-template name="error_msg">
		...
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '306'">
			<xsl:call-template name="error_msg">
		...
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '307'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH307'" />
					<xsl:with-param name="statusDesc" select="'Fecha se encuentra vacio'" />
			</xsl:call-template>
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '308'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH308'" />
					<xsl:with-param name="statusDesc" select="'Fecha es invalido'" />
			</xsl:call-template>
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '309'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH309'" />
					<xsl:with-param name="statusDesc" select="'Identificador de Channel esta vacio'" />
			</xsl:call-template>
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '310'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH310'" />
					<xsl:with-param name="statusDesc" select="'Identificador de channel es invalido'" />
			</xsl:call-template>
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '311'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH311'" />
					<xsl:with-param name="statusDesc" select="'Identificador de pais esta vacio'" />
			</xsl:call-template>
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '312'">
			<xsl:call-template name="error_msg">
		...
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '313'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH313'" />
					<xsl:with-param name="statusDesc" select="'Identificador de servicio esta vacio'" />
			</xsl:call-template>
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '314'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH314'" />
					<xsl:with-param name="statusDesc" select="'Identificador de servicio es invalido'" />
			</xsl:call-template>
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '315'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH315'" />
					<xsl:with-param name="statusDesc" select="'Identificador de cliente esta vacio'" />
			</xsl:call-template>
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '316'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH316'" />
					<xsl:with-param name="statusDesc" select="'Identificador de cliente es invalido'" />
			</xsl:call-template>
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '317'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH317'" />
					<xsl:with-param name="statusDesc" select="'Identificador de contrato esta vacio'" />
			</xsl:call-template>
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '318'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH318'" />
					<xsl:with-param name="statusDesc" select="'Identificador de contrato es invalido'" />
			</xsl:call-template>
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '319'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH319'" />
					<xsl:with-param name="statusDesc" select="'Identificador de Folio esta vacio'" />
			</xsl:call-template>
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '320'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH320'" />
					<xsl:with-param name="statusDesc" select="'Identificador de Folio es invalido'" />
			</xsl:call-template>
		</xsl:when>
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '321'">
			<xsl:call-template name="error_msg">
		...
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '346'">
			<xsl:call-template name="error_msg">
		...
		<xsl:when test="/request-context/services-responses/consulta_pago/validacionesfondo/message/body/validation_code = '341'">
			<xsl:call-template name="error_msg">
					<xsl:with-param name="statusCode" select="'CEH341'" />
					<xsl:with-param name="statusDesc" select="'Error, Rango de fecha inicio es mayor que fecha final '" />
			</xsl:call-template>
		</xsl:when>
